...
class rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.range1 = range1 = -20

        ##################################################
        # Blocks
        ##################################################
        self._range1_range = Range(-100, 0, 1, -20, 200)
        self._range1_win = RangeWidget(self._range1_range, self.set_range1, 'range1', "counter_slider", float)
        self.top_grid_layout.addWidget(self._range1_win)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, './in.txt', False)
        self.blocks_file_sink_0.set_unbuffered(True)
        self.analog_simple_squelch_cc_0 = analog.simple_squelch_cc(range1, 1)
    ...
    def set_range1(self, range1):
        self.range1 = range1
        self.analog_simple_squelch_cc_0.set_threshold(self.range1)
